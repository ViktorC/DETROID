 ...
 * of {@link #util.EngineParameters EngineParameters}. This is also the number of bits that will be parsed 
 * for the respective field of the input of the method {@link #util.EngineParameters.set(String) set(String)}. 

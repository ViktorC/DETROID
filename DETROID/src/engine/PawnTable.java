...
public class PawnTable extends HashTable<PawnTable.PTEntry> {
	 ...
	 *
	 */
	public static class PTEntry implements HashTable.Entry<PTEntry> {
		...
		public static final int SIZE = SizeOf.POINTER.numOfBytes + SizeOf.BOOLEAN.numOfBytes + SizeOf.SHORT.numOfBytes + SizeOf.LONG.numOfBytes;
	...
	public PawnTable() {
		super(-1, PTEntry.SIZE);
	}
	public PawnTable(int sizeMB) {
		super(sizeMB, PTEntry.SIZE);
	}
	@Override
	public long size() {

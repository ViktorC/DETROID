...
import main.java.net.viktorc.detroid.engine.Bitboard.*;
import main.java.net.viktorc.detroid.util.BitOperations;
import main.java.net.viktorc.detroid.util.Copiable;
import main.java.net.viktorc.detroid.util.Hashable;

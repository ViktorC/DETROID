...
class Move implements Comparable<Move> {
	...
	static final byte SHIFT_TO = 6;
	static final byte SHIFT_MOVED = 12;
	static final byte SHIFT_CAPTURED = 16;
	static final byte SHIFT_TYPE = 20;
	static final byte MASK_FROM = 63;
	static final byte MASK_TO = 63;
	static final byte MASK_MOVED = 15;
	static final byte MASK_CAPTURED = 15;

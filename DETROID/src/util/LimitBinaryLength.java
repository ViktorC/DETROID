 ...
 * {@link #util.Parameters Parameters}.
 * This is also the number of bits that will be parsed for the respective field of the input of the method
 * {@link #util.Parameters.initFromGrayCodeString(String) initFromBinaryString(String)}. If

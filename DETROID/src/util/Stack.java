 ...
 * It does not hold incrementally updated references to the last element neither does it have a 'length' field, thus its
 * {@link #getTail() getTail}, {@link #length() length}, and {@link #toArray() toArray} methods have O(n) time-complexity and are not intended
 * to be used in performance sensitive applications.
 * 
 * @author Viktor
 *
 */

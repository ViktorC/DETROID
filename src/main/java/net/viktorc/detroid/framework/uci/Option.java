...
public class Option<T> {
  ...
  /**
   * Returns the optional default value of the setting. For a {@link net.viktorc.detroid.framework.uci.Option.ButtonOption}, it is never
   * present; for all other option types, it is always present.
   *
  ...
  /**
   * Returns an optional set of values a {@link net.viktorc.detroid.framework.uci.Option.ComboOption} can possibly take on. For all other
   * option types, it is never present.
   *

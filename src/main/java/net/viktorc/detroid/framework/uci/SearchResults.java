...
public class SearchResults {
	 ...
	 * @param score An optional search score value in centipawns. If the move was found using other methods than
	 * classic search and there is no score associated with it, the score should be null.
	 * @param scoreType An optional search score type. If the score is not present, the score type is ignored. If the
	 * score is present, the score type cannot be null either.
	 */
	...
	/**
	 * Returns an optional 16-bit integer that may hold the score of the search results in centipawns, or if it is a
	 * mate score, the mate distance.
	 * 

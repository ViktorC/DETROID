...
/**
 * A time-to-depth test record containing a position and the depth to which it is to be searched. It is used for time-to-depth speedup
 * measurements for SMP.
 *
 * @author Viktor
 */

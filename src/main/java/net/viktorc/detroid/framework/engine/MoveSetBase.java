...
/**
 * A pre-calculated move set 'database' that saves the time costs of calculating move sets on the fly at the price of about 850KBytes. It contains
...
enum MoveSetBase {
	 ...
	 */
	private MoveSetBase(long rookMagicNumber, long bishopMagicNumber, int rookMagicShift, int bishopMagicShift) {
		int index;
		long bit;

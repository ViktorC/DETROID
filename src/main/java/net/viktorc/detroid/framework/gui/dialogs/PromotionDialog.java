...
/**
 * A dialog for handling chess promotions by presenting a set of selectable pieces to promote to. The selected piece is returned by the
 * {@link #showAndWait() showAndWait} method.
 *
 * @author Viktor
 */
